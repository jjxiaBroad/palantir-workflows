...
# Build and push Docker image for the PIPseq downsample pipeline to ECR
...
REPOSITORY_NAME="pipseq-downsample-qc"
IMAGE_TAG="${1:-latest}"
...
echo "  nextflow run downsample.nf --qc_container '${IMAGE_NAME}' ..."
